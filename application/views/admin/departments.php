...
<h3 class="m-0 nowrap">Departments</h3>
<a class="btn btn-primary" style="margin:20px" href="<?php echo base_url(); ?>index.php/department/add">Add new</a>
</div>
...
<tbody>
    <?php
foreach ($departments as $eachData) {
                        ?>
                <tr>
                ...
                <td>
                    ...
                    <?php echo anchor('/department/edit/' . $eachData->_id, 'Edit'); ?>
                    <br/>
                    <?php echo anchor('/admin/departmentdelete/' . $eachData->_id, 'Delete', array('onclick' => "return confirm('Do you want delete this record')")); ?>
                    </div>
                    </div>
                    </div> </td>
                </tr>
