...
<ul id="sidebar_menu">
<li class="mm-active">
<a href="<?php echo base_url(); ?>index.php/student/dashboard" aria-expanded="false">
<img src="<?php echo base_url('assets') ?>/img/menu-icon/1.svg" alt>
<span>HOME</span>
</a>
</li>
<li class="mm-active">
<a href="<?php echo base_url(); ?>index.php/myprofile" aria-expanded="false">
<i class="ti-user"></i>
<span>My Profile</span>
</a>
</li>
<li class="mm-active">
<a href="<?php echo base_url(); ?>index.php/auth/logout" aria-expanded="false">
...
<li>
<a href="#"> <img src="<?php echo base_url('assets') ?>/img/icon/bell.svg" alt> </a>
</li>
<li>
<a href="#"> <img src="<?php echo base_url('assets') ?>/img/icon/msg.svg" alt> </a>
</li>
</div>
</div>
</div>
